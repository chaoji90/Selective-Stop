...
def search_func(xloader, network, criterion, scheduler, w_optimizer, a_optimizer, epoch_str, print_freq, logger, gradient_clip,warmup,epoch,analyser,la_tracker):
  ...
  logger.log("----------------------------------------------------------------------------------------------------")
  la_tracker.update(epoch, ev, network.module.genotype())
  la_tracker.early_stop(epoch, 1.3, 0)
...
def main(xargs):
  ...
  la_tracker = utils_ES.EVLocalAvg()
  ...
  for epoch in range(start_epoch, total_epoch):
    ...
    search_w_loss, search_w_top1, search_w_top5 = search_func(search_loader, network, criterion, w_scheduler, w_optimizer, a_optimizer, epoch_str, xargs.print_freq, logger, xargs.gradient_clip,args.warm_up,epoch,analyser,la_tracker)
